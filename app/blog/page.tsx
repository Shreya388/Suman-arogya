...
const blogPosts: BlogPost[] = [
  {
    title:
      "The Science of Gut Health: Bridging Ancient Ayurveda with Modern Microbiome Research",
    excerpt:
      "Discover how traditional Ayurvedic views on Agni (digestive fire) align with modern clinical findings on gut microbiota and systemic immunity.",
  ...
  {
    title:
      "Managing Chronic Inflammation Naturally Through Targeted Dietary Protocols",
    excerpt:
      "An evidence-based exploration of anti-inflammatory herbs, spices, and clinical meal sequencing designed to reduce systemic pain.",
    ...
    author: {
      ...
      avatar:
        "https://images.unsplash.com/photo-1594824813576-92c2a613b53c?auto=format&fit=crop&w=200&q=80",
    },
  ...
  {
    title:
      "Understanding Your Doshas: A Clinical Perspective on Metabolic Types",
    excerpt:
      "Break down Vata, Pitta, and Kapha through the lens of modern endocrinology and personalized medicine frameworks.",
  ...
  {
    title:
      "Holistic Approaches to Managing Type 2 Diabetes and Insulin Resistance",
    excerpt:
      "Review clinical protocols combining herbal adjuncts, structured exercise routines, and glycemic index mapping for stable blood sugar.",
...

  {
    ...
    excerpt:
      "Why topical treatments alone often fall short, and how deep internal detoxification supports long-term skin barrier restoration.",
  ...
  {
    title:
      "The Role of Adaptogenic Herbs in Managing Chronic Stress and Fatigue",
    excerpt:
      "An analytical look at Ashwagandha, Brahmi, and Turmeric in down-regulating cortisol and restoring adrenal balance.",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
            ...
            <p className="text-slate-500 text-base font-light max-w-2xl mx-auto">
              Explore evidence-based medical articles, diet roadmaps, and
              expert commentary blending traditional Ayurveda with modern
              clinical practice.
            </p>
          </div>
                ...
                <div className="lg:col-span-6 p-6 sm:p-8 lg:p-10 flex flex-col justify-between">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center gap-3 text-xs font-semibold text-slate-400">
                      <span className="text-teal-600 uppercase tracking-wider font-bold">
          ...
          <div className="mt-20 bg-gradient-to-br from-slate-900 via-slate-950 to-slate-900 rounded-[2.5rem] p-8 md:p-16 text-white shadow-2xl relative overflow-hidden flex flex-col md:flex-row items-center justify-between gap-10">
            ...
            <div className="space-y-4 max-w-xl relative z-10 text-center md:text-left">
              ...
              <h3 className="text-3xl font-black tracking-tight">
                Never miss a clinical update
              </h3>

              <p className="text-slate-400 text-sm md:text-base font-light leading-relaxed">
                Get our curated monthly digest straight to your inbox.
                Direct clinical insights, holistic diet guides, and expert
                wellness tips.
              </p>
