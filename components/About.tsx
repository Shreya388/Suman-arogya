        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center mb-16">
          ...
          <div className="lg:col-span-5 order-last lg:order-first">
            <div className="relative">
              ...
              <div className="absolute -top-4 -left-4 w-72 h-72 bg-lime-50 rounded-2xl -z-10"></div>
              ...
              <div className="w-full aspect-[4/5] bg-slate-50 border border-slate-200 rounded-2xl shadow-md p-8 flex flex-col justify-between">
                <div>
                  <span className="text-sm font-bold text-lime-600 tracking-wider uppercase">Our Mission</span>
                ...
                <div className="bg-lime-600 text-white p-4 rounded-xl shadow-sm mt-6">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="pt-2">
              <Link
                href="/about"
                className="inline-flex items-center text-lime-600 hover:text-lime-700 font-bold transition-colors group"
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {coreValues.map((value, idx) => (
              <div key={idx} className="p-6 rounded-2xl border border-slate-100 bg-slate-50 hover:bg-white hover:shadow-xl hover:shadow-slate-100 transition-all duration-300">
                <div className="p-3 bg-lime-50 w-fit rounded-xl mb-4">
                  {value.icon}
                </div>
