            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 border border-slate-200 rounded-xl text-sm focus:outline-none focus:border-lime-500 text-slate-800"
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 border border-slate-200 rounded-xl text-sm focus:outline-none focus:border-lime-500 text-slate-800 resize-none"
              ...
              <button
                type="submit"
                className="w-full bg-lime-600 hover:bg-lime-700 text-white font-bold py-3.5 px-6 rounded-xl transition-colors shadow-md shadow-lime-100"
              >
                Send Message
              </button>
            </form>
